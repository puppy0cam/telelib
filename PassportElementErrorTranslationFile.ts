...
export class PassportElementErrorTranslationFile extends PassportElementError implements IPassportElementErrorTranslationFile {
    public constructor(data: IPassportElementErrorTranslationFile, token?: string | Bot) {
        "use strict";
        super(data, token);
    }
