import { Array_of_ChatMember, Array_of_GameHighScore, Array_of_Message, Array_of_Update, Chat, ChatMember, File, Message, Message_or_True, Poll, sendRequest, StickerSet, tokenedClassWrapping, tokenedResultWrapping, tokenlessResultWrapping, True, User, UserProfilePhotos, WebhookInfo } from "./_internals.mjs";
const cacheHandler = (() => {
