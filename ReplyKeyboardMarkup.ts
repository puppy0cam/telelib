import { Bot, KeyboardButton, IKeyboardButton, Array_of_Array_of_KeyboardButton } from "./_internals.js";
...
export class ReplyKeyboardMarkup extends Bot implements IReplyKeyboardMarkup {
    constructor(data: IReplyKeyboardMarkup, token?: string | Bot) {
        "use strict";
        super(data, token);
        if (this.keyboard) {
